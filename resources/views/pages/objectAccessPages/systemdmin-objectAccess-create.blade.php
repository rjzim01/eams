...
<main id="main" class="main">
    <div class="pagetitle">
      <h1>Object Access Dashboard : System admin</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{{ 'dashboard' }}">Home</a></li>
          <li class="breadcrumb-item active">Object Access Create</li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
      ...
      <div class="col-lg-10">
        <div class="card c-shadow">
          <div class="card-body">
            ...
            @endif
            <form action='{{ route('systemadminobjectAccess_store') }}' method="post" class="row g-3 needs-validation" novalidate>
                ...
                <div class="col-md-9">
                  <select class="form-select " name="user_id" id="user_id" required>
                    ...
                    @foreach ($user as $result)
                        <option value="{{ $result->id }}">Name : {{ $result->name }} , Company : {{ $result->company_name }}</option>
                    @endforeach
                  </select>
                </div>
                {{-- <div class="col-md-1 show-access">
                  <a href="{{ route('obectaccess_edit',$result->id) }}"><span class="badge rounded-pill text-bg-success">Alread Have</span></a>
                </div> --}}
              </div>
