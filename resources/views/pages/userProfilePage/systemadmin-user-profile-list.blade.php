...
<main id="main" class="main">
    <div class="pagetitle">
      <h5>User-Profile & Role Management : System Admin</h5>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{{ 'dashboard' }}">Home</a></li>
          <li class="breadcrumb-item active">Company-User-Role List </li>
        </ol>
      </nav>
    </div>
    <!-- End Page Title -->
                    ...
                    @foreach ($UserProfile as $result)
                        <tr>
                             ...
                             <td class="text-center">
                              <a href="{{ route('system-user-edit',$result->id) }}"><span class="badge rounded-pill text-bg-warning">Edit</span></a>
